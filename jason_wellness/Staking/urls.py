...
from .views import Add_Staking_Referral, Delete_Referral_stake, List_Stake_Claim_History, List_Stake_credit,List_Staking_Referral,List_Stake, StakeHistoryManagementTable, StakecreditHistoryManagementTable
...
urlpatterns = [
    ...
    re_path(r'^user_stake_credit_history_table/(?P<pk>[-\w]+)/$', login_required(StakecreditHistoryManagementTable.as_view(),login_url=loginurl), name='user_stake_credit_history_table'),
    ...
    path('Stake_credit_Claim_API/',views.Stake_credit_Claim_API,name="Stake_credit_Claim_API"),
    path('stake_credit_withdraw_history/',views.stake_credit_withdraw_history,name="stake_credit_withdraw_history"),
    path('stake_credit_withdraw_values/',views.stake_credit_withdraw_values,name="stake_credit_withdraw_values"), 
    path('stake_credit_claim_update/',views.stake_credit_claim_update,name="stake_credit_claim_update"),
    path('stake_credit_claim_history/',views.stake_Credit_claim_history_,name="stake_credit_claim_history"),
